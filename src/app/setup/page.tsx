...
export default function Setup() {
  return <main id="main" className="narrow"><p className="eyebrow">CONNECTION REQUIRED</p><h1>학습 공간을<br />연결해 주세요.</h1>
    ...
    <ol className="setup-list"><li>Supabase 프로젝트에 저장소의 migration을 적용하세요.</li><li>Supabase Auth에서 GitHub 로그인을 활성화하고 callback URL을 등록하세요.</li><li>배포 환경에 아래 세 환경변수를 설정하고 다시 빌드하세요.</li></ol>
